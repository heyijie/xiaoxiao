...
_jsonp("https://www.ymatou.com/guess/api/getGuessLikeProducts")
.then(function(res){
      // console.log(res.result.wall.list);
      // 获取商品列表;
      var goodsJSON = res.result.Products;
...
function randomPage(json){
      ...
      json.forEach(function(ele){
            ...
            //                   </div>
            //             </div> `
            html+= `    <div class="box-shop">
                              <div class="shop-image">
                                    <img src="${ele.MainPic}" alt="" width=212 height=212>
                              </div>
                              <div class="box-title">
                                    <p>${ele.Title}</p>
                              </div>
